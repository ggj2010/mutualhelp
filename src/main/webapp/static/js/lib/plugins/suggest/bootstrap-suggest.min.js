...
function(a) {
    ...
    var b = {
        init: function(b) {
            function c(a, b, c) {
                b.is(":visible") || ("left" === c.listAlign ? b.css({
                    left: a.siblings("div").width() - a.parent().width(),
                    right: "auto"
                }) : "right" === c.listAlign && b.css({
                    left: "auto",
                    right: "0"
                }))
            }
            ...
            function m(a, b, c) {
                var d, e, f, g, h, j, l, m = a.parent().find("ul.dropdown-menu"),
                o = 0,
                p = ['<table class="table table-condensed">'];
                if (c = c || s, b = i(b), b === !1 || 0 === (d = b.value.length)) return m.empty().hide(),
                a;
                if (c.showHeader) {
                    g = "<thead><tr>";
                    for (f in b.value[0]) k(f) !== !1 && (g += 0 === o ? "<th>" + (c.effectiveFieldsAlias[f] || f) + "(" + d + ")</th>": "<th>" + (c.effectiveFieldsAlias[f] || f) + "</th>", o++);
                    g += "</tr></thead>",
                    p.push(g)
                }
                for (p.push("<tbody>"), e = 0; d > e; e++) {
                    o = 0,
                    h = "",
                    j = b.value[e][c.idField] || "",
                    l = b.value[e][c.keyField] || "";
                    for (f in b.value[e]) l || c.indexKey !== o || (l = b.value[e][f]),
                    j || c.indexId !== o || (j = b.value[e][f]),
                    o++,
                    k(f) !== !1 && (h += '<td data-name="' + f + '">' + b.value[e][f] + "</td>");
                    h = '<tr data-index="' + e + '" data-id="' + j + '" data-key="' + l + '">' + h + "</tr>",
                    p.push(h)
                }
                return p.push("</tbody></table>"),
                m.html(p.join("")).show(),
                n(a, m, c),
                m.css("max-height") && Number(m.css("max-height").replace("px", "")) < Number(m.find("table:eq(0)").css("height").replace("px", "")) && Number(m.css("min-width").replace("px", "")) < Number(m.css("width").replace("px", "")) ? m.css("padding-right", "20px").find("table:eq(0)").css("margin-bottom", "20px") : m.css("padding-right", 0).find("table:eq(0)").css("margin-bottom", 0),
                a
            }
            function n(b, c, e) {
                c = c || $dropdownMenu,
