package com.ggj.mutualhelp.modules.weixin.util;
...
import com.ggj.mutualhelp.modules.weixin.vo.Item;
import com.ggj.mutualhelp.modules.weixin.vo.Music;
import com.thoughtworks.xstream.XStream;
import com.thoughtworks.xstream.io.xml.DomDriver;
import com.thoughtworks.xstream.io.xml.XppDriver;

/**
 * @ClassName:XmlExchangeUtil.java
 * @Description:  xml转换成bean
 * @author gaoguangjin
 * @Date 2015-11-19 下午4:34:32
 */
public class XmlExchangeUtil {
	 ...
	 * @throws IOException
	 */
	public static InputMessage getObjectByXml(HttpServletRequest request) throws UnsupportedEncodingException, IOException {
		// 处理接收消息
